...
- 图标对话框标题对多适配图标的区分形式由小黑点改进为标签（可替换「ALT」、无适配「UND」）
- 「申请统计」底部显示标记点说明文字
...
| [@梁月丶](http://www.coolapk.com/u/620760) / [祈愿图标包](http://www.coolapk.com/apk/com.liangyue.iconpack.hhope) | ![Hhope](art/ic_launcher_hhope.png) |
